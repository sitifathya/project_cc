                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                $sql = "SELECT periksa.*, pasien.nama as pasien, paramedik.nama as paramedik FROM periksa 
                                                ...
                                                foreach ($result as $row) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="hapus.php?id=<?= $row['id'] ?>"><button class="btn btn-danger">hapus</button></a>
                                                        </td>
                                                    </tr>
                                                <?php }
                                                ?>
